...
```sh
# command-line
nodsig ... --plugin eosio::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `nodsig` command-line:
...
```sh
# command-line
nodsig ... --plugin eosio::chain_plugin --disable-replay-opts
```
