...
[[info]]
| Additional configuration is required to produce blocks. Please read [Configuring Block Producing Node](https://developers.eos.io/eosio-nodsig/docs/environment-producing-node).
...
```
```sh
# nodsig startup params
nodsig ... -- plugin eosio::producer_plugin [options]
```
