...
There are several ways to configure a `nodsig` environment for development and testing. Which option to use largely depends on what the project goals are. Some practical options are provided below.
...
* [Configure nodsig as a Local Single-node Testnet](00_local-single-node-testnet.md) 
...
* [Configure nodsig as a Local Two-Node Testnet](01_local-multi-node-testnet.md)
* [Configure nodsig as a Local 21-Node Testnet](https://github.com/EOSIO/eos/blob/master/tutorials/bios-boot-tutorial/README.md)
