...
```console
Usage: clsig set action [OPTIONS] SUBCOMMAND
...
clsig set action permission sandwichfarm eosio.system voteproducer voting -p sandwichfarm@voting

#Now can execute the transaction with the previously set permissions. 
clsig system voteproducer approve sandwichfarm someproducer -p sandwichfarm@voting
```
