...
const static name system_account_name    { N(sig) };
const static name null_account_name      { N(sig.null) };
const static name producers_account_name { N(sig.prods) };
...
const static name eosio_auth_scope       { N(sig.auth) };
const static name eosio_all_scope        { N(sig.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name eosio_any_name  { N(sig.any) };
const static name eosio_code_name { N(sig.code) };
