...
mkdir -p ${PROJECT}/${VERSION}/opt/sig/lib/cmake
...
echo "class Eosio < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/sig/eos/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/sig/eos/releases/download/v${VERSION}\"
