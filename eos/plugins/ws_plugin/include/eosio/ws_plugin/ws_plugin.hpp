...
namespace eosio {
   ...
   class ws_plugin : public appbase::plugin<ws_plugin>
   {
      ...
      private:
         std::unique_ptr<class ws_plugin_impl> my;
...
FC_REFLECT(eosio::error_results_ws::error_info_ws::error_detail_ws, (message)(file)(line_number)(method))
FC_REFLECT(eosio::error_results_ws::error_info_ws, (code)(name)(what)(details))
FC_REFLECT(eosio::error_results_ws, (code)(message)(error))
FC_REFLECT(eosio::ws_plugin::get_supported_apis_result, (apis))
