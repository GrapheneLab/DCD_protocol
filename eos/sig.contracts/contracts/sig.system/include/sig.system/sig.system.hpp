...
#include <sig.system/exchange_state.hpp>
#include <sig.system/native.hpp>
...
namespace eosiosystem {
    ...
    * sig.system contract
    * 
    * sig.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] bid_refund {
      name         bidder;
      asset        amount;
   ...
   struct [[eosio::table("global"), eosio::contract("sig.system")]] eosio_global_state : eosio::blockchain_parameters {
   ...
   struct [[eosio::table("global2"), eosio::contract("sig.system")]] eosio_global_state2 {
      eosio_global_state2(){}
   ...
   struct [[eosio::table("global3"), eosio::contract("sig.system")]] eosio_global_state3 {
      eosio_global_state3() { }
   ...
   struct [[eosio::table("global4"), eosio::contract("sig.system")]] eosio_global_state4 {
      eosio_global_state4() { }
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] producer_info {
      name                                                     owner;
      ...
      eosio::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            ...
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 sig.system
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] voter_info {
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("sig.system")]] refund_request {
      name            owner;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("sig.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
    ...
    */
   class [[eosio::contract("sig.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"sig.token"_n};
         static constexpr eosio::name ram_account{"sig.ram"_n};
         static constexpr eosio::name fee_account{"sig.feebank"_n};
         static constexpr eosio::name ramfee_account{"sig.ramfee"_n};
         static constexpr eosio::name stake_account{"sig.stake"_n};
         static constexpr eosio::name bpay_account{"sig.bpay"_n};
         static constexpr eosio::name vpay_account{"sig.vpay"_n};
         static constexpr eosio::name names_account{"sig.names"_n};
         static constexpr eosio::name saving_account{"sig.saving"_n};
         static constexpr eosio::name rex_account{"sig.rex"_n};
         static constexpr eosio::name null_account{"sig.null"_n};
          ...
          * have selected it as a proxy. Other accounts must refresh their confirmprod to
          ...
          *     The remaining inflation will be sent to the `sig.saving` account.
