...
namespace eosio {
   ...
   /**
    * @defgroup eosiomsig sig.msig
    * @ingroup eosiocontracts
    * sig.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[eosio::contract("sig.msig")]] multisig : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiomsig sig.msig
} /// namespace eosio
