...
###############################################################
# nodsig_chainbase_allocation_test
#
...
try:
    ...
    cmd = "create account -j eosio sample SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq\
         SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq --delay-sec 600 -p eosio"
    trans = producerNode.processclsigCmd(cmd, cmd, silentErrors=False)
    assert trans

    # Schedule a new producer to trigger new producer schedule for "global_property_object"
    newProducerAcc = Account("newprod")
    newProducerAcc.ownerPublicKey = "SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq"
    newProducerAcc.activePublicKey = "SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq"
