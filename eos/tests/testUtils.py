...
class Utils:
    ...
    EosClientPath="programs/clsig/clsig"
    MiscEosClientArgs="--no-auto-ksigd"

    EosWalletName="ksigd"
    EosWalletPath="programs/ksigd/"+ EosWalletName

    EosServerName="nodsig"
    EosServerPath="programs/nodsig/"+ EosServerName
