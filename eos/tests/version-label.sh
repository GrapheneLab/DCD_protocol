#!/bin/bash
# The purpose of this test is to ensure that the output of the "nodsig --version" command matches the version string defined by our CMake files
# If the environment variable BUILDKITE_TAG is empty or unset, this test will echo success
echo '##### nodsig Version Label Test #####'
...
# get nodsig version
ACTUAL=$($EOSIO_ROOT/build/bin/nodsig --version) || : # nodsig currently returns -1 for --version
# test
