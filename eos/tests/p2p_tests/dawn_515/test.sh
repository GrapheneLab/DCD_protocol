...
read -d '' genesis << EOF
{
  ...
  "initial_key": "SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq",
...
private-key = ['SIG5ZTBCeK3BucyLxMe7E4mUpS3wXziqoSMxKhtq2aXuwRykhcigq','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
b5idbios=`./programs/clsig/clsig -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clsig/clsig -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clsig/clsig -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
