...
# nodsig_run_test
#
# General test that tests a wide range of general use actions around nodsig and ksigd
#
###############################################################
...
try:
    ...
    contractDir="unittests/contracts/sig.token"
    wasmFile="sig.token.wasm"
    abiFile="sig.token.abi"
